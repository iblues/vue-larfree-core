  ...
  <div class="topnavbar" :style="{paddingLeft: paddingleft}">
    <div class="navbar" style="margin-bottom: 0;background-color: #fff">
      <div class="navbar-header">
        <a v-if="!collapse" class="navbar-minimalize minimalize-styl-2 btn" @click="collapseTab">
          <i class="el-icon iconfont iconshouqi" style="font-size: 24px" />
        </a>
        <a v-if="collapse" class="navbar-minimalize minimalize-styl-2 btn " @click="collapseTab">
          <i class="el-icon iconfont iconzhankai" style="font-size: 24px" />
        </a>
      ...
      <div class="icon">
        <span style="position: relative">
          <i class="el-icon iconfont icon40one" />
          <div class="dot" />
        </span>
        <el-dropdown>
          <span class="el-dropdown-link">
            {{ userInfo && userInfo.name }}<i class="el-icon-caret-bottom el-icon--right" />
          </span>
